          ...
          <div className="bg-[#1E293B] rounded p-6 sm:p-10 border border-slate-700/50 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-[#0F172A] p-4 rounded border border-slate-800 space-y-1.5">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  1. I pair AI-drafted articles with expert human editing & Canva graphics, staging ready-to-review drafts in WordPress or Google Drive while building your promotional social media campaign inside CoSchedule.
              </div>
