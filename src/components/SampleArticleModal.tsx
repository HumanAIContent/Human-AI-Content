...
const REAL_ESTATE_ARTICLE = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'The Altman Brothers\' website showcases the brand\'s personality while also making it easy for visitors to search for properties for sale and contact the real estate agency.',
    ...
    },
    {
      ...
      body: 'Dolly Lenz\'s website is another great example of a real estate website that does many things right. It has beautiful pictures of properties for sale, engaging descriptions, and a clean design that makes it easy to navigate.',
