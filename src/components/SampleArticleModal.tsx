...
const WOMENS_HEALTH_ARTICLE = {
  ...
  metaDescription: 'Discover how specialized pelvic health & perinatal physical therapy relieve discomfort, restore core stability, & support postpartum recovery.',
  sections: [
    {
