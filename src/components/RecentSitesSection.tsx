...
export const SampleArticleModal: React.FC<SampleArticleModalProps> = ({ isOpen, onClose, selectedSite }) => {
  ...
  if (selectedSite) {
    // Card 1: Tokyo Rehabilitation (site-1) → Pilates
    if (selectedSite.id === 'site-1' || selectedSite.domain?.includes('tokyophysicaltherapy.com')) {
      article = PILATES_ARTICLE;
    }
    // Card 2: Innovacious (site-5) → Real Estate
